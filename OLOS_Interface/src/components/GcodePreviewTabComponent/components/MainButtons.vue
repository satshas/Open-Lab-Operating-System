<template>
  <div class="row fit items-center justify-between main-buttons-header">
    <div class="row flex-center col-lg col-md col-sm-6 col-xs-6">
      <q-toggle
    ...
    <div class="row justify-end ccol-lg col-md col-sm-6 col-xs-6 q-gutter-sm">
      <q-btn
        @click="downloadPNG"
        stack
        color="green-6"
